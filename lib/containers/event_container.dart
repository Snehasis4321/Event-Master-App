  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.push(context,
          MaterialPageRoute(builder: (context) => EventPage(data: data))),
      child: Padding(
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: ColorFiltered(
                  ...
                  child: Image.network(
                    "https://cloud.appwrite.io/v1/storage/buckets/6487074849d89dcf51ac/files/${data.data["image"]}/view?project=6486f854bd95ae96b223&mode=admin",
                    fit: BoxFit.cover,
                  ),
                ),
              ),
